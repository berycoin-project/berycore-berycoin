Berycoin Core version 0.13.3 is now available from:

  <https://download.berycoin.org/berycoin-0.13.3/>
...
Berycoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
