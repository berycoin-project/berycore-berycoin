...
VERSION=
commit=false
url=https://github.com/berycoin-project/litecore-berycoin
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the bitcoin, gitian-builder, gitian.sigs.BERY, and berycoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/berycoin-project/litecore-berycoin
...
then
	# Make output folder
	mkdir -p ./berycoin-binaries/${VERSION}
	...
	popd
        ...
        if [[ $commitFiles = true ]]
        then
	    # Commit to gitian.sigs.BERY repo
            echo ""
